 ...
 */
router.get('/accounts', authMiddleware as any, adminMiddleware, (_req: Request, res: Response) => {
 ...
 */
router.delete('/accounts/:id', authMiddleware as any, adminMiddleware, (req: Request, res: Response) => {
