 ...
 */
export async function legalShieldMiddleware(req, res, next) {
    ...
    if (!SUPABASE_AVAILABLE) {
        if (!IS_PRODUCTION) {
            console.warn(`[LegalShield] DEVELOPMENT BYPASS — Supabase not configured. ` +
...
//# sourceMappingURL=legalShield.js.map