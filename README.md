...
| **NiriumVault (our own contract)** | ❌ **Not on mainnet** — audit-gated | — |
...
| **LCP legal layer** | ❌ Off — terms pending legal review | — |
...
| Internal JARGUS security audit v3.0 (AAA, 83/83 PASS) | ✅ Complete |
