        ...
        >
            <div className="relative group">
                ...
                <img 
                    src="/logos/logo.png" 
                    alt="Nirium Logo" 
                    className={`${size} h-auto object-contain drop-shadow-[0_0_25px_rgba(45,235,232,0.3)] hover:drop-shadow-[0_0_40px_rgba(45,235,232,0.5)] transition-all duration-700`}
                />
            </div>
        </motion.div>
    );
