  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-to-r from-stellar-teal to-stellar-yellow text-black font-black hover:opacity-90 shadow-[0_0_20px_rgba(45,235,232,0.3)]",
      },
      size: {
        ...
        icon: "h-9 w-9",
        hero: "h-14 px-10 text-lg uppercase tracking-wider",
      },
    },
    defaultVariants: {
      variant: "default",
