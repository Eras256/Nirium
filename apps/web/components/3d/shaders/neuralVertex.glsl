// Neural Particle Vertex Shader - GPGPU Optimized
// Implements cursor attractor physics with inverse-square law
...
void main() {
  // Base position with noise-based organic movement
  ...
  // Dynamic size based on life and proximity to cursor
  float dynamicSize = uParticleSize * (0.5 + life * 0.5);
  float cursorProximityBoost = smoothstep(3.0, 0.5, distToCursor) * 2.0;
