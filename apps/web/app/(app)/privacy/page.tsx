    ...
    <div className="min-h-screen pt-28 pb-24 px-4 md:px-8 bg-black text-zinc-300">
      <div className="max-w-3xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-sm font-mono text-zinc-500">Última actualización / Last updated: Mayo 13, 2026</p>
        </div>
        ...
        <div className="prose prose-invert prose-zinc max-w-none">
          ...
          <p>Nirium Protocol Team (en adelante, el "Responsable"), es responsable del tratamiento de los datos personales que nos proporcione. El Responsable opera bajo el marco de desarrollo del proyecto "Nirium Protocol", una herramienta de software de código abierto. Puede contactarnos en el correo electrónico: <strong>xvaiosx7@gmail.com</strong>.</p>
          ...
          <div className="bg-zinc-900/50 p-6 rounded-2xl border border-zinc-800">
            ...
            <p className="text-sm mt-4">Nirium Protocol Team is responsible for the processing of personal data collected for Nirium Protocol. We only collect hashed API keys, webhook URLs, and usage metrics for authentication, rate limiting, and security purposes. We do not collect PII, sensitive data, biometrics, or financial data, nor do we custody user funds.</p>
            <p className="text-sm mt-2">Data is only shared with essential infrastructure providers (Supabase, Railway) under data processing agreements. We do not sell data. We use essential session cookies only, no marketing tracking. You may exercise your ARCO rights (Access, Rectification, Cancellation, Opposition) by contacting <strong>xvaiosx7@gmail.com</strong>. We will respond within 20 business days.</p>
          </div>
        </div>
      </div>
    </div>
