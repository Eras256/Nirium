            ...
            <div className="relative z-10 pt-8 pb-20">
                <div className="max-w-5xl mx-auto px-6">
                        ...
                        <div className="glass-panel p-12 rounded-3xl border border-stellar-yellow/20 bg-gradient-to-br from-stellar-yellow/5 to-transparent relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-sm text-gray-400 leading-relaxed">
                                        Power users can scaffold custom units using our CLI. Run <code className="bg-white/5 px-1 rounded text-stellar-teal">npx nirium create-unit</code> to inject custom Soroban kernels or Python/Node.js logic directly into the Strategic Hub.
                    ...
                    <div className="mt-32 text-center section-lift">
                        <h3 className="text-3xl font-bold mb-8">Ready to initiate the Protocol?</h3>
...
const STEPS = [
    ...
    },
    {
        ...
        description: "Empower your agent via the Skills Marketplace. Install modular skills like 'Atomic Execution Logic', 'Price Monitor', or 'Liquidity Balancer' to customize your unit's logic.",
